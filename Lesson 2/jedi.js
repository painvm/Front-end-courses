function QuadraticEquation() {
    ...
    var visibleCoefficients = {
        a: (a > 1 ? a : (a == 1 ? '' : (a < -1 ? a : "-"))),
        b:(b > 1 ? ' + ' + b : (b == 1 ? ' + ' : (b < -1 ? ' - ' + Math.abs(b) : " - "))),
        c:(c >= 1 ? ' + ' + c : (c == 0 ? '' : ' - ' + Math.abs(c)))
    }
    var equationInput = (visibleCoefficients.a + "x" + "<sup>2<\/sup>" + visibleCoefficients.b + "x" + visibleCoefficients.c + ' = ' + rightside + (rightside != 0 ? "<br><br><span class='text-info'>Let's transform the equation<\/span><br><br>" + (a > 1 ? a : (a == 1 ? '' : (a < -1 ? a : "-"))) + "x" + "<sup>2<\/sup>" + (b > 1 ? ' + ' + b : (b == 1 ? ' + ' : (b < -1 ? ' - ' + Math.abs(b) : " - "))) + "x" + ((c - rightside) > 0 ? ' + ' + (c - rightside) : ((c - rightside) == 0 ? '' : " - " + Math.abs((c - rightside)))) + " = 0" : ''));
